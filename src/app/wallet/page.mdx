...
The Zing Protocol wallet manages your USDC balance for all platform transactions including memberships, donations, and storage purchases. {{ className: 'lead' }}
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.prod.zing.you/wallet/balance \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.prod.zing.you/wallet/topup \
      -H "x-signature: {base64_signature}" \
  -H "x-message-bytes: {base64_message}" \      -d amount="50.00"
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.prod.zing.you/wallet/payout \
      -H "x-signature: {base64_signature}" \
  -H "x-message-bytes: {base64_message}" \      -d amount="25.00" \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.prod.zing.you/wallet/transactions \
      -H "x-signature: {base64_signature}" \
...
- [Memberships](/memberships) - Subscribe to creators
