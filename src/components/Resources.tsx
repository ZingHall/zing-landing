...
function ResourcePattern({
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-linear-to-r from-[#FFF1EB] to-[#FFE8E0] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#2A1A14] dark:to-[#2D1F1A]"
        style={style}
      />
      <motion.div
