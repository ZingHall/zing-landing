...
export const socialMediaProfiles = [
  ...
  { title: 'X', href: 'https://x.com/ZingonSui', icon: XIcon },
  { title: 'GitHub', href: 'https://github.com/orgs/ZingHall', icon: GitHubIcon },
  { title: 'Telegram', href: 'https://t.me/+6GzPkM_26ws0ZDRl', icon: TelegramIcon },
