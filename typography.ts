    ...
    typography: ({ theme }) => ({
      DEFAULT: {
        css: {
          ...
          '--tw-prose-links-hover': theme('colors.primary / 0.8'),
          '--tw-prose-links-underline': theme('colors.primary / 0.3'),
          ...
          '--tw-prose-invert-links-hover': theme('colors.primary / 0.8'),
          '--tw-prose-invert-links-underline': theme('colors.primary / 0.3'),
